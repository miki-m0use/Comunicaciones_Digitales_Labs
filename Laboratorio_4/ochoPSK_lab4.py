...
class ochoPSK_lab4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ochoPSK_lab4")
        ...
        self.connect((self.analog_random_source_x_0_1, 0), (self.blocks_repeat_0, 0))
        self.connect((self.analog_random_source_x_0_1, 0), (self.fec_ber_bf_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_multiply_xx_0_0, 0))
        self.connect((self.blocks_add_xx_0_1, 0), (self.blocks_complex_to_float_0, 0))
        ...
        self.connect((self.blocks_repeat_0, 0), (self.digital_chunks_to_symbols_xx_0_1, 0))
        ...
        self.connect((self.digital_constellation_decoder_cb_0_1, 0), (self.fec_ber_bf_0, 1))
        self.connect((self.digital_constellation_decoder_cb_0_1, 0), (self.qtgui_number_sink_0_1, 0))
...
def main(top_block_cls=ochoPSK_lab4, options=None):
