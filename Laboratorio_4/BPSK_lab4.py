...
class BPSK_lab4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BPSK_lab4")
        ...
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_throttle2_0_0_0, 0))
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self.blocks_throttle2_0_0_0, 0), (self.fec_ber_bf_0, 0))
...
def main(top_block_cls=BPSK_lab4, options=None):
